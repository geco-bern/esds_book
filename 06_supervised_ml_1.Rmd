...
```{r sample, fig.cap="Comparison of different methods to split data. Black represent training data splits and red training data splits."}
...
```{r pivot, fig.cap='Visualizsation of turning a table from wide format (right) into long format (left). Figure from [https://cmdlinetips.com/2020/02/r-for-data-science-book-gets-tidyr-1-0-0-friendly/](https://cmdlinetips.com/2020/02/r-for-data-science-book-gets-tidyr-1-0-0-friendly/).'}
