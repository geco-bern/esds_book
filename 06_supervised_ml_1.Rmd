...
```{r, echo = FALSE, fig.cap="Comparing model fits on training data set."}
...
```{r, echo = FALSE, fig.cap="Comparing model fits on validation data set."}
...
```{r, echo = FALSE, fig.cap="Comparing model fits when extrapolating."}
...
```{r tradeoff, fig.cap="Trade-off between bias and variance"}
...
```{r simple-complex, fig.cap="Comparison of simple and complex model fits."}
...
```{r rsample, fig.cap="Stratified sampling using `initial_split()` from rsample package."}
...
```{r pivot, fig.cap='Visualizsation of turning a table from wide format (right) into long format (left). Figure from [R for Data Science](https://cmdlinetips.com/2020/02/r-for-data-science-book-gets-tidyr-1-0-0-friendly/).'}
