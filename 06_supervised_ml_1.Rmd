...
```{r eval=F}
train(
  x = select(df, PPFD_IN, VPD_F, TA_F),
  y = df$GPP_NT_VUT_REF,
  method = "knn"
  )
```
...
<img src="./../data/images/onehot.png" style="width: 60%;"/> 

Figure from [www.kaggle.com](https://www.kaggle.com/dansbecker/using-categorical-data-with-one-hot-encoding).
...
```{r eval=F}
load("./data/FLX_CH-Lae_FLUXNET2015_FULLSET_HH_2004-2014_1-3_CLEAN.RData")
