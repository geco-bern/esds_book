...
```{r eval=FALSE}
## NOT ADVISABLE
my_df$temp_soil <- (my_df$temp_soil - 32) * 5 / 9
my_df$temp_air  <- (my_df$temp_air  - 32) * 5 / 9
my_df$temp_leaf <- (my_df$temp_leaf - 32) * 5 / 9
```
...
my_df$temp_soil <- convert_fahrenheit_to_celsius(my_df$temp_soil)
my_df$temp_air  <- convert_fahrenheit_to_celsius(my_df$temp_air)
my_df$temp_leaf <- convert_fahrenheit_to_celsius(my_df$temp_leaf)
```
