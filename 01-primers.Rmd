...
![Tidy data is defined by organising variables by columns, observations by rows, and each cell containing one value. Figure from Grolemund & Wickham XXXrefXXX](https://r4ds.had.co.nz/tidy-data.html)
