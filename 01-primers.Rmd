...
Start by selecting the correct project in Renku. Then select the tab _'Environments'_ and click _'New'_ to start a new interactive environment.
...
- Add spaces aound operators and breaks to make code easier to read.
- Use `<-`, not `=`, for allocating a value to a variable.
