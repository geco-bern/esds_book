...
Most of you have worked with R before, most likely within RStudio. For this course, we're going to work with RStudio and Jupyter notebooks. Each chapter is made of two parts. The first part is a tutorial to learn the basics of data science in an environmental context where we will work with Jupyter notebooks (on Renku). As most of you probably have never worked with this platform, we'll give you a short introduction to it in this very first tutorial. The second part usually consists of a somewhat more extensive exercise in RStudio where the contents of the tutorials are applied.
