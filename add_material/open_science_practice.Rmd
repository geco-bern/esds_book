...
XXX show an example for a file that can be downloaded from some public
data repository.
...
Below is an example for using ingestr function to download daily climate data (e.g. Average temperature). Code is commented out temporaily because data has to be downloaded to your desktop in advance which may cause a long time. 

This data is available in Euler. See commented data path below. To run analysis, you can either download data from Euler to your own hard-drive to run, or directly run in Euler.
