...
XXX this code is not executable. libraries not correctly specified,
there are absolute paths. please use ggplot, not qplot. thanks.
...
qplot(x=date, y=temp,
      data=as.data.frame(df_watch$data), na.rm=TRUE,
      main="Daily air temperature at example site",
