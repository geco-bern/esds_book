...
scientific findings may not be reliable. Practicing open science offers
...
siteinfo1 \<- tibble(sitename="site1",lon=
...
y=temp))+geom_point()+ ggtitle("Daily air temperature at example site")
