...
ingestr?                
Koen’s interface to the Harmonized World Soil Database ‘HWSD’ web services: https://bluegreen-labs.github.io/hwsdr/
...
- Sharing raw and processed data on a server/cluster (e.g. euler at ETH, other at Imperial)
- Make data and code publicly available (Zenodo, etc.)
- Show services and how they work (e.g. Zenodo and its webhooks that integrate with github releases) 
