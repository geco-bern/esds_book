...
Below you can see how with the R-base call `plot()` you can plot the _SpatialPoints_ directly. But we will have to also provide a map to plot them onto. The loaded shapefile of Europe will also be used in the next section called Shapefiles.
