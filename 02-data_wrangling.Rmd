...
As you can see below, the number of columns differ between the joined and not joined data frames. Since _ddf_allsites_joined_ contains all the columns present in _ddf_allsites_, we do see common column names towards the end of the list of _ddf_allsites_joined_'s columns as this was the second argument. 
```{r}
names(ddf_allsites)
