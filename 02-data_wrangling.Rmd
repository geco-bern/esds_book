...
### Bonus: Functional programming II

Functions can be applied to any list. Because lists can consist of any type of objects, `map()` is a powerful approach to "iterating" over multiple instances of the same class of object and can be used for all sorts of tasks. In the following, list elements are data frames of daily data and the mapping function `lm()` fits a linear regression model of GPP versus PPFD to each sites' data.
...
```{r}
gg + geom_jitter(color = "red", width = 0.1)
```
