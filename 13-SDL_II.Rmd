...
#### FLUXNET
We will once again be using the FLUXNET dataset, that you have gotten familiar with in the previous tutorials. We want to try to predict the variable [`NEE_CUT_REF`](https://fluxnet.org/data/fluxnet2015-dataset/fullset-data-product/), which expresses the fluxes in gC $m^{-2} d^{-1}$, using the ndvi value of the corresponding region.
...
![Monthly NDVI vs $CO_{2}$ Flux of CH Oensingen Tower in 2014](./figures/ndvi_vs_CO2.gif)
