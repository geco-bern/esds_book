...
![](https://upload.wikimedia.org/wikipedia/commons/5/52/Eddy_Covariance_IRGA_Sonic.jpg)
...
![](https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/Photosynthesis_equation.svg/640px-Photosynthesis_equation.svg.png)
...
[The Normalised Difference Vegetation Index](https://en.wikipedia.org/wiki/Normalized_difference_vegetation_index) (NDVI) uses this property, by measuring the difference between the difference in reflectance between red light (*Red*) and near-infrared light (*NIR*) as $NDVI = \frac{NIR - Red}{NIR + Red}$.
...
![](./figures/location_of_towers.png)
...
![Monthly NDVI vs $CO^{2}$ Flux of CH Oensingen Tower in 2014](./figures/ndvi_vs_CO2.gif)
...
Available Data by Tower (2000-2014):
![](./figures/data_available_1.png)
...
![Distribution of CO~2~ Flux by Tower](./figures/Distribution_per_Tower.png)
