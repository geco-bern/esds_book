...
## Exercice: is your workflow reproducible?

1. Clone the CES project template: https://github.com/computationales/R-proj-template

2. Download some public available data (put in ./data but not on git – be creative!)
...
6. They should be able to reproduce the analysis and explain you what you did 
